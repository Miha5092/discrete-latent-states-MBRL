...
![Continuous Model Architecture](images/Continuous_Training.jpeg)

The representation and dynamics models directly learn the continuous latent representations $h_i$ and $\hat{h}_{i+1}$.

#### Discrete Model

![Discrete Model Architecture](images/Discrete_Training.jpeg)
...
![Training Instability](images/training_instability.png)

### Embedding Dimension and Performance

![Embedding Dimension and Performance](images/embedding_dimensions.png)
